...
class TestCheckTarget(unittest.TestCase):
    ...
    def test_get_url(self):
        ...
        target = CheckTarget(
            host="example.com", port=80, scheme="http", path="/test"
        )
...
class TestEmailNotifier(unittest.TestCase):
    ...
    def test_notify_success(self, mock_smtp):
        ...
        self.assertEqual(
            mock_smtp_instance.sendmail.call_args[0][0], "sender@example.com"
        )
        # Second arg should be recipient list
        self.assertEqual(
            mock_smtp_instance.sendmail.call_args[0][1],
...
class TestServerMonitor(unittest.TestCase):
    ...
    def test_run_check_and_notify_no_alert(self):
        ...
        monitor = ServerMonitor(
            checker=mock_checker, notifier=mock_notifier, alert_codes=[500]
        )
    ...
    def test_run_check_and_notify_with_alert(self):
        ...
        self.assertIn(
            "Internal Server Error", mock_notifier.notify.call_args[0][1]
        )
